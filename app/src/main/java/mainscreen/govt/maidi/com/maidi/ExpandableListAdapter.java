...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        txtNum.setText(Html.fromHtml("<b>"+memData.getVillage()+"</b>"));
        txtNum.setText(Html.fromHtml("<b>"+memData.getDays()+"</b>"));
...
//        txtProName.setText(Html.fromHtml("<b>"+gData.getVillage()+"</b>"));
//        txtProName.setText(Html.fromHtml("<b>"+gData.getDays()+"</b>"));
       // txtProName.setText(Html.fromHtml("<b>"+gData.getHrs()+"</b>"));
