...
import tablefixheaders.adapters.MonthlyRecyclerViewAdapter3;
import tablefixheaders.adapters.RecyclerViewAdapter1;
import tablefixheaders.adapters.RecyclerViewAdapter3;

public class MonthlyFragment3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(
                R.layout.activity_monthly3, container, false);
        return rootView;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        MonthlyRecyclerViewAdapter3 adapter = new MonthlyRecyclerViewAdapter3(items);
