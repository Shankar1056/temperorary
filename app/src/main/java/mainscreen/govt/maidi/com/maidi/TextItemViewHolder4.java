...
public class TextItemViewHolder4 extends RecyclerView.ViewHolder {
    ...
    public TextItemViewHolder4(final View itemView) {
        super(itemView);
    ...
    public  void AddData1() {
        ...
        boolean isInserted = myDb.insertData13(Et, Select_week, Select_village, select_state, Select_block, Select_vaccine, Select_planhours);
        if(isInserted == true)
