...
import tablefixheaders.adapters.AEFIRecyclerViewAdapter3;


public class AefiPage3Fragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        AEFIRecyclerViewAdapter3 adapter = new AEFIRecyclerViewAdapter3(items);
