...
public class Fragmentweek3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(
                R.layout.activity_week3, container, false);
        return rootView;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerViewAdapter3 adapter = new RecyclerViewAdapter3(items);
        recyclerView2 = (RecyclerView) view.findViewById(R.id.recycler_view3);
