...
import tablefixheaders.adapters.MonthlyRecyclerViewAdapter2;
import tablefixheaders.adapters.RecyclerViewAdapter1;
import tablefixheaders.adapters.RecyclerViewAdapter2;

public class MonthlyFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(
                R.layout.activity_monthly2, container, false);
        return rootView;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        MonthlyRecyclerViewAdapter2 adapter = new MonthlyRecyclerViewAdapter2(items);
