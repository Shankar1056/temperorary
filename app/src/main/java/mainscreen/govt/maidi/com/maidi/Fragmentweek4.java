...
public class Fragmentweek4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(
                R.layout.activity_week4, container, false);
        return rootView;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerViewAdapter4 adapter = new RecyclerViewAdapter4(items);
        recyclerView3 = (RecyclerView) view.findViewById(R.id.recycler_view4);
