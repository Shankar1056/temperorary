...
import tablefixheaders.adapters.MonthlyRecyclerViewAdapter4;
import tablefixheaders.adapters.RecyclerViewAdapter1;
import tablefixheaders.adapters.RecyclerViewAdapter4;

public class MonthlyFragment4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(
                R.layout.activity_monthly4, container, false);
        return rootView;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        MonthlyRecyclerViewAdapter4 adapter = new MonthlyRecyclerViewAdapter4(items);
