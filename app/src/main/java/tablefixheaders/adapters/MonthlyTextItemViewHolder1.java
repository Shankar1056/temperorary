...
public class MonthlyTextItemViewHolder1 extends RecyclerView.ViewHolder {
    ...
    public MonthlyTextItemViewHolder1(final View itemView) {
        super(itemView);
        ...
        call1.enqueue(new Callback<monthlyViewResponse>() {
            ...
            public void onFailure(Call<monthlyViewResponse> call, Throwable t) {
                ...
                builder.setMessage("Week Two register Error");
