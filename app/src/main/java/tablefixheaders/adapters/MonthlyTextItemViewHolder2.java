...
public class MonthlyTextItemViewHolder2 extends RecyclerView.ViewHolder {
    ...
    public MonthlyTextItemViewHolder2(final View itemView) {
        super(itemView);
        ...
        call1.enqueue(new Callback<monthlyViewResponse>() {
            ...
            public void onFailure(Call<monthlyViewResponse> call, Throwable t) {
                ...
                builder.setMessage("Week Three register Error");
