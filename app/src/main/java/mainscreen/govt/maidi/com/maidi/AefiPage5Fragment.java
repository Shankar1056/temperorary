...
import tablefixheaders.adapters.AEFIRecyclerViewAdapter5;


public class AefiPage5Fragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        AEFIRecyclerViewAdapter5 adapter = new AEFIRecyclerViewAdapter5(items);
