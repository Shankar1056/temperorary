...
import tablefixheaders.adapters.AEFIRecyclerViewAdapter1;
import tablefixheaders.adapters.RecyclerViewAdapter2;


/* Fragment used as page 1 */
public class AefiPage1Fragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        AEFIRecyclerViewAdapter1 adapter = new AEFIRecyclerViewAdapter1(items);
