...
public class RecyclerViewAdapterSurvy extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public RecyclerViewAdapterSurvy(Context context, ArrayList<HashMap<String, String>> myDataset, RecyclerView recyclerView) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof ViewHolderRow) {
           ...
           // userViewHolder.txtAddress.setText(map.get("KEY_ADDRESS"));
    ...
    public class ViewHolderRow extends RecyclerView.ViewHolder {
        ...
        public ViewHolderRow(View v) {
            super(v);
            txtEmail = (TextView)v.findViewById(R.id.txtName);
            txtPhone = (TextView)v.findViewById(R.id.txtAddress);
        }
