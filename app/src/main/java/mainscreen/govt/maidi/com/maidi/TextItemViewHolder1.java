...
public class TextItemViewHolder1 extends RecyclerView.ViewHolder {
    ...
    public TextItemViewHolder1(final View itemView) {
        super(itemView);
    ...
    public  void AddData2() {
        ...
        boolean isInserted = myDb.insertData11(Et, Select_week, Select_village, select_state, Select_block, Select_vaccine, Select_planhours);
        if(isInserted == true)
