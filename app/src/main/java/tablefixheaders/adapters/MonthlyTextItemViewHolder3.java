...
public class MonthlyTextItemViewHolder3 extends RecyclerView.ViewHolder {
    ...
    public MonthlyTextItemViewHolder3(final View itemView) {
        super(itemView);
        ...
        call1.enqueue(new Callback<monthlyViewResponse>() {
            ...
            public void onFailure(Call<monthlyViewResponse> call, Throwable t) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(
                        itemView.getContext());
                builder.setTitle("Momthly");
                builder.setMessage("Week Four register Error");
